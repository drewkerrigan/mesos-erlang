...
-ifndef(scheduler_protobuf).
-define(scheduler_protobuf, true).

-define(scheduler_protobuf_gpb_version, "3.22.3").
...
-ifndef('EVENT.RESCIND_PB_H').
-define('EVENT.RESCIND_PB_H', true).
-record('Event.Rescind',
        {offer_id                       % = 1, {msg,'OfferID'}
        }).
-endif.
...
-ifndef('CALL.DECLINEINVERSEOFFERS_PB_H').
-define('CALL.DECLINEINVERSEOFFERS_PB_H', true).
-record('Call.DeclineInverseOffers',
        {inverse_offer_ids = [],        % = 1, [{msg,'OfferID'}]
         filters                        % = 2, {msg,'Filters'} (optional)
        }).
-endif.
...
-ifndef('EVENT.ERROR_PB_H').
-define('EVENT.ERROR_PB_H', true).
-record('Event.Error',
        {message                        % = 1, string
        }).
-endif.
...
-ifndef('CALL.KILL_PB_H').
-define('CALL.KILL_PB_H', true).
-record('Call.Kill',
        {task_id,                       % = 1, {msg,'TaskID'}
         agent_id,                      % = 2, {msg,'AgentID'} (optional)
         kill_policy                    % = 3, {msg,'KillPolicy'} (optional)
        }).
-endif.
...
-ifndef('CALL.REQ_PB_H').
-define('CALL.REQ_PB_H', true).
-record('Call.Req',
        {requests = []                  % = 1, [{msg,'Request'}]
        }).
-endif.

-ifndef('CALL.MESSAGE_PB_H').
-define('CALL.MESSAGE_PB_H', true).
-record('Call.Message',
        {agent_id,                      % = 1, {msg,'AgentID'}
         executor_id,                   % = 2, {msg,'ExecutorID'}
         data                           % = 3, bytes
        }).
-endif.

-ifndef('CALL.RECONCILE.TASK_PB_H').
-define('CALL.RECONCILE.TASK_PB_H', true).
-record('Call.Reconcile.Task',
        {task_id,                       % = 1, {msg,'TaskID'}
         agent_id                       % = 2, {msg,'AgentID'} (optional)
        }).
-endif.

-ifndef('CALL.RECONCILE_PB_H').
-define('CALL.RECONCILE_PB_H', true).
-record('Call.Reconcile',
        {tasks = []                     % = 1, [{msg,'Call.Reconcile.Task'}]
        }).
-endif.

-ifndef('CALL.ACKNOWLEDGE_PB_H').
-define('CALL.ACKNOWLEDGE_PB_H', true).
-record('Call.Acknowledge',
        {agent_id,                      % = 1, {msg,'AgentID'}
         task_id,                       % = 2, {msg,'TaskID'}
         uuid                           % = 3, bytes
        }).
...
-ifndef('CALL.SHUTDOWN_PB_H').
-define('CALL.SHUTDOWN_PB_H', true).
...
-ifndef('CALL.ACCEPTINVERSEOFFERS_PB_H').
-define('CALL.ACCEPTINVERSEOFFERS_PB_H', true).
-record('Call.AcceptInverseOffers',
        {inverse_offer_ids = [],        % = 1, [{msg,'OfferID'}]
         filters                        % = 2, {msg,'Filters'} (optional)
        }).
-endif.

-ifndef('CALL.DECLINE_PB_H').
-define('CALL.DECLINE_PB_H', true).
-record('Call.Decline',
        {offer_ids = [],                % = 1, [{msg,'OfferID'}]
         filters                        % = 2, {msg,'Filters'} (optional)
        }).
-endif.

-ifndef('CALL.ACCEPT_PB_H').
-define('CALL.ACCEPT_PB_H', true).
-record('Call.Accept',
        {offer_ids = [],                % = 1, [{msg,'OfferID'}]
         operations = [],               % = 2, [{msg,'Offer.Operation'}]
         filters                        % = 3, {msg,'Filters'} (optional)
        }).
-endif.

-ifndef('CALL.SUBSCRIBE_PB_H').
-define('CALL.SUBSCRIBE_PB_H', true).
-record('Call.Subscribe',
...
-record('Call',
        {framework_id,                  % = 1, {msg,'FrameworkID'} (optional)
         type,                          % = 2, {enum,'Call.Type'} (optional)
         subscribe,                     % = 3, {msg,'Call.Subscribe'} (optional)
         accept,                        % = 4, {msg,'Call.Accept'} (optional)
         decline,                       % = 5, {msg,'Call.Decline'} (optional)
         accept_inverse_offers,         % = 13, {msg,'Call.AcceptInverseOffers'} (optional)
         decline_inverse_offers,        % = 14, {msg,'Call.DeclineInverseOffers'} (optional)
         kill,                          % = 6, {msg,'Call.Kill'} (optional)
         shutdown,                      % = 7, {msg,'Call.Shutdown'} (optional)
         acknowledge,                   % = 8, {msg,'Call.Acknowledge'} (optional)
         reconcile,                     % = 9, {msg,'Call.Reconcile'} (optional)
         message,                       % = 10, {msg,'Call.Message'} (optional)
         request                        % = 11, {msg,'Call.Req'} (optional)
        }).
-endif.
...
-ifndef('EVENT.FAILURE_PB_H').
-define('EVENT.FAILURE_PB_H', true).
-record('Event.Failure',
        {agent_id,                      % = 1, {msg,'AgentID'} (optional)
         executor_id,                   % = 2, {msg,'ExecutorID'} (optional)
         status                         % = 3, int32 (optional)
        }).
-endif.

-ifndef('EVENT.MESSAGE_PB_H').
-define('EVENT.MESSAGE_PB_H', true).
...
-record('Event.Subscribed',
        {framework_id,                  % = 1, {msg,'FrameworkID'}
...
-ifndef('EVENT.OFFERS_PB_H').
-define('EVENT.OFFERS_PB_H', true).
-record('Event.Offers',
        {offers = []                    % = 1, [{msg,'Offer'}]
        }).
-endif.
...
-ifndef('EVENT.INVERSEOFFERS_PB_H').
-define('EVENT.INVERSEOFFERS_PB_H', true).
-record('Event.InverseOffers',
        {inverse_offers = []            % = 1, [{msg,'InverseOffer'}]
        }).
-endif.

-ifndef('EVENT.RESCINDINVERSEOFFER_PB_H').
-define('EVENT.RESCINDINVERSEOFFER_PB_H', true).
-record('Event.RescindInverseOffer',
        {inverse_offer_id               % = 1, {msg,'OfferID'}
        }).
-endif.
...
-ifndef('EVENT.UPDATE_PB_H').
-define('EVENT.UPDATE_PB_H', true).
-record('Event.Update',
        {status                         % = 1, {msg,'TaskStatus'}
        }).
-endif.
...
-record('Event',
        {type,                          % = 1, {enum,'Event.Type'} (optional)
         ...
         offers,                        % = 3, {msg,'Event.Offers'} (optional)
         inverse_offers,                % = 9, {msg,'Event.InverseOffers'} (optional)
         rescind,                       % = 4, {msg,'Event.Rescind'} (optional)
         rescind_inverse_offer,         % = 10, {msg,'Event.RescindInverseOffer'} (optional)
         update,                        % = 5, {msg,'Event.Update'} (optional)
         message,                       % = 6, {msg,'Event.Message'} (optional)
         failure,                       % = 7, {msg,'Event.Failure'} (optional)
         error                          % = 8, {msg,'Event.Error'} (optional)
        }).
-endif.
