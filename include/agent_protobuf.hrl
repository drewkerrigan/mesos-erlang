...
-ifndef(agent_protobuf).
-define(agent_protobuf, true).

-define(agent_protobuf_gpb_version, "3.22.3").
...
-ifndef('RESPONSE.GETCONTAINERS.CONTAINER_PB_H').
-define('RESPONSE.GETCONTAINERS.CONTAINER_PB_H', true).
-record('Response.GetContainers.Container',
        {framework_id,                  % = 1, {msg,'FrameworkID'}
         executor_id,                   % = 2, {msg,'ExecutorID'}
         executor_name,                 % = 3, string
         container_id,                  % = 4, {msg,'ContainerID'}
         container_status,              % = 5, {msg,'ContainerStatus'} (optional)
         resource_statistics            % = 6, {msg,'ResourceStatistics'} (optional)
        }).
-endif.

-ifndef('RESPONSE.GETCONTAINERS_PB_H').
-define('RESPONSE.GETCONTAINERS_PB_H', true).
-record('Response.GetContainers',
        {containers = []                % = 1, [{msg,'Response.GetContainers.Container'}]
        }).
-endif.
...
-record('Response',
        {type,                          % = 1, {enum,'Response.Type'} (optional)
         ...
         get_containers                 % = 10, {msg,'Response.GetContainers'} (optional)
        }).
-endif.
