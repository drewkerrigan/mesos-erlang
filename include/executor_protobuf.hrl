...
-ifndef(executor_protobuf).
-define(executor_protobuf, true).

-define(executor_protobuf_gpb_version, "3.22.3").
...
-ifndef('EVENT.KILL_PB_H').
-define('EVENT.KILL_PB_H', true).
-record('Event.Kill',
        {task_id,                       % = 1, {msg,'TaskID'}
         kill_policy                    % = 2, {msg,'KillPolicy'} (optional)
        }).
-endif.
...
-ifndef('CALL.UPDATE_PB_H').
-define('CALL.UPDATE_PB_H', true).
-record('Call.Update',
...
-record('Call.Subscribe',
        {unacknowledged_tasks = [],     % = 1, [{msg,'TaskInfo'}]
         unacknowledged_updates = []    % = 2, [{msg,'Call.Update'}]
        }).
-endif.
...
-record('Call',
        {executor_id,                   % = 1, {msg,'ExecutorID'}
         ...
         type,                          % = 3, {enum,'Call.Type'} (optional)
         subscribe,                     % = 4, {msg,'Call.Subscribe'} (optional)
         update,                        % = 5, {msg,'Call.Update'} (optional)
         message                        % = 6, {msg,'Call.Message'} (optional)
        }).
-endif.
...
-ifndef('EVENT.LAUNCH_PB_H').
-define('EVENT.LAUNCH_PB_H', true).
-record('Event.Launch',
        {task                           % = 1, {msg,'TaskInfo'}
        }).
-endif.
...
-record('Event.Subscribed',
        {executor_info,                 % = 1, {msg,'ExecutorInfo'}
         framework_info,                % = 2, {msg,'FrameworkInfo'}
         agent_info                     % = 3, {msg,'AgentInfo'}
        }).
-endif.

-ifndef('EVENT.ACKNOWLEDGED_PB_H').
-define('EVENT.ACKNOWLEDGED_PB_H', true).
-record('Event.Acknowledged',
        {task_id,                       % = 1, {msg,'TaskID'}
         uuid                           % = 2, bytes
        }).
-endif.
...
-record('Event',
        {type,                          % = 1, {enum,'Event.Type'} (optional)
         ...
         acknowledged,                  % = 3, {msg,'Event.Acknowledged'} (optional)
         launch,                        % = 4, {msg,'Event.Launch'} (optional)
         kill,                          % = 5, {msg,'Event.Kill'} (optional)
         message,                       % = 6, {msg,'Event.Message'} (optional)
         error                          % = 7, {msg,'Event.Error'} (optional)
        }).
-endif.
